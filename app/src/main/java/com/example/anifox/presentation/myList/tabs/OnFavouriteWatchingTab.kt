...
import com.example.anifox.databinding.FragmentFavouriteOnWatchingBinding
...
@AndroidEntryPoint
class OnFavouriteWatchingTab : Fragment() {
    private var _binding: FragmentFavouriteOnWatchingBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFavouriteOnWatchingBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun observeOnState(){
        viewModel.getListOnWatchingPaging().onEach {
