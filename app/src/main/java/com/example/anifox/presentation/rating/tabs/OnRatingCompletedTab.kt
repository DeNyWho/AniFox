...
import com.example.anifox.databinding.FragmentOnRatingCompletedTabBinding
...
@AndroidEntryPoint
class OnRatingCompletedTab : Fragment() {
    private var _binding: FragmentOnRatingCompletedTabBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentOnRatingCompletedTabBinding.inflate(inflater, container, false)
        return binding.root
    }
