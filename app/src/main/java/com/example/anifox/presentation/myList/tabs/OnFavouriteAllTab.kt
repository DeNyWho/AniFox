...
import com.example.anifox.databinding.FragmentFavouriteOnAllBinding
...
@AndroidEntryPoint
class OnFavouriteAllTab : Fragment() {
    private var _binding: FragmentFavouriteOnAllBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFavouriteOnAllBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun observeOnState(){
        viewModel.getListOnAllPaging().onEach {
